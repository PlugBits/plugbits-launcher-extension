...
const I18N_MESSAGES = {
  ja: {
    ...
    app_catalog_cache_refresh_btn: 'アプリ一覧を更新',
  ...
  en: {
    ...
    general_cache_title: 'Data refresh',
    ...
    app_catalog_cache_refresh_btn: 'Refresh app list',
...
const API_USAGE_DISPLAY_GROUP_MAP = {
  shortcuts: ['shortcut', 'shortcuts', 'command_palette'],
  watchlist: ['watchlist_bulk', 'watchlist'],
  record_pin: ['record_pin', 'pins'],
  recent: ['recent'],
  spreadsheet: ['overlay', 'overlay_records', 'overlay_acl', 'overlay_file_upload', 'lookup_candidates'],
  admin: [
    'metadata_app',
    'metadata_views',
    'metadata_fields',
